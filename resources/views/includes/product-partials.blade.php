  ...
  <div class="shell">
    ...
    <div class="range range-xs-center">
      ...
      <div class="cell-xs-6 cell-sm-5 cell-md-4">
        ...
        <div class="product product-grid">
          ...
          <h5 class=" product-title offset-top-20">
            <a href="
              {{'wigs/'.$product->category->path().'/'.$product->texture->texturePath()}}
            ">
      ...
      <div class="product-block-hover">
        <!-- Product Add To cart-->
        <a class="btn btn-sm btn-danger btn-icon btn-icon-left product-btn offset-top-20"
          href="{{'wigs/'.$product->category->path().'/'.$product->texture->texturePath()}}"><span
            class="icon mdi mdi-cart-outline"></span>Shop Now</a>
      </div>
    </div>
  </div>
  @empty
